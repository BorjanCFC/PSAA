// N градови се поврзани меѓусебно со патишта, при што од ако може да се стигне од град А до
// град Б, може да се стигне и од град Б до град А. Ако група луѓе тргнува на пат од одреден град,
// до кои се градови може да стигне?
// Во прв ред се внесува број на градови. Во втор ред се имињата на градовите одделени со празно
// место. Во третиот ред е бројот на патишта. Во наредните редови се дадени два броја кои ги
// означуваат градовите помеѓу кои има пат. На крај се внесува град. За градот на излез треба да
// се добијат сите други градови до кои може да се дојде.
