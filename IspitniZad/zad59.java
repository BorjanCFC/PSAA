// Да се напише функција која како аргумент ќе добива јазол од поврзан граф и ќе креира копија на графот. 
// Функцијата треба да ја враќа копијата од графот. Под копија не се претпоставува посочување на оригиналниот граф.
// Да се напише главна програма во која ќе се тестира работата на функцијата. 
// Во главната програма да се испечати резултатот добиен од функцијата.
