// Да се напише функција во класата бинарно дрво која ќе провери колку пара од внатрешни јазли во дрвото кои 
// се во врска родител-дете го задоволуваат условот и двата да немаат десно дете. Функцијата да врати бројот на такви парови.
