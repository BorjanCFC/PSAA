...
// Ако помеѓу два града има пат, тогаш може да се стигне од првиот во вториот и од вториот во првиот град. 
// Група туристи тргнува на пат од град кој го внесува корисникот. Да се одредат сите градови до кои може да стигне таа група туристи.
// Прво корисникот го внесува бројот на градови, по што корисникот ги внесува имињата на градовите. 
// Потоа се внесува бројот на патишта. За секој пат се внесува парот од градови кои тој пат ги поврзува.
// На крај, корисникот внесува град од каде тргнуваат група туристи. 
// За внесената вредност, на екран треба да се прикажат сите градови до кои може да се дојде.
// Напомена: Реализацијата може да ја направите во главна програма, со помош на една функција, или да искористите повеќе помошни функции.
